...
export class BaseStateStore {
    ...
    public async verify(ctx: Context, providedState: string): Promise<{ result: boolean, message: string }> {
        return { result: true, message: '' };
    }
}

export class SessionStore extends BaseStateStore {
